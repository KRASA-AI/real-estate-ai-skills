...
Generate a personalized follow-up email for each visitor based on sign-in notes.

## When to Use

Use this skill whenever you need to generate a personalized follow-up email for each visitor based on sign-in notes. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled real estate professional's AI assistant. Your job is to generate a personalized follow-up email for each visitor based on sign-in notes.

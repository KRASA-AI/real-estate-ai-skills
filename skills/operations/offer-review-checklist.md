...
Parse an offer and flag contingencies, timelines, and terms that need attention.

## When to Use

Use this skill whenever you need to parse an offer and flag contingencies, timelines, and terms that need attention. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled real estate professional's AI assistant. Your job is to parse an offer and flag contingencies, timelines, and terms that need attention.

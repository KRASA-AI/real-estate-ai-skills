...
- Identify whether the asset will publish in California, Colorado (⚠️ June 30, 2026 deadline for SB 24-205 — verify deployer obligations for any housing-decision AI system), Texas, New York, Washington, or any jurisdiction with its own AI labeling / data-handling statute. Flag any state with a sub-county or municipal rule.
...
2. **Map each L1–L4 element to its jurisdictional disclosure obligation.** Use a rules matrix keyed on (a) jurisdiction, (b) asset channel (MLS / brokerage site / Zillow / Realtor.com / IG / FB / email / AI chatbot / agent voicemail / open-house sign), (c) AI level. Typical obligations to check, at minimum:
   ...
   - **State AI / image-disclosure statutes** — California AB 723 (effective 1/1/2026): digitally altered marketing images require a clear disclosure AND a link / URL / QR code to the unaltered original; misdemeanor exposure for non-compliance. **Colorado AI Act (SB 24-205, effective June 30, 2026 — ⚠️ 7 weeks from this skill's last update):** the law defines "consequential decision" to include the lease or purchase of residential real estate in Colorado, meaning AI systems that contribute in a meaningful way to any Colorado housing transaction trigger deployer obligations. Deployer obligations for real estate agents and brokerages in Colorado: (a) establish and maintain a written AI risk management policy and program that identifies, documents, and mitigates known or reasonably foreseeable risks of algorithmic discrimination — the policy must reference a nationally recognized framework such as the NIST AI Risk Management Framework or ISO/IEC 42001; (b) provide consumers with notice when a high-risk AI system is used in a consequential decision; (c) provide consumers a meaningful way to request human review of an AI-influenced consequential decision; (d) perform an impact assessment for any high-risk AI system before deployment and annually thereafter — the assessment must document the system's purpose, training data at a high level, known limitations, and discrimination-mitigation measures. **Scope clarification:** the Colorado law applies to AI systems used to make or substantially influence leasing or purchase decisions, not merely AI-drafted copy; however, an AI system that scores buyer readiness (e.g., lead scoring) or surfaces price recommendations could qualify. If the brokerage uses a third-party CRM, valuation, or predictive-analytics tool to influence which Colorado clients are contacted or at what price, the deployer obligations may be triggered. For AI-drafted marketing copy alone, the consumer-notice obligation applies if the copy is consumer-facing and the system qualifies as a high-risk system under the Act's definitions. Note: the Colorado AI Policy Work Group proposed a revised replacement framework on March 17, 2026; as of this skill's update, the June 30, 2026 compliance deadline is still in effect — verify with broker counsel before relying on any proposed replacement. Other states have analogous statutes in varying stages — Texas RAIGA, Florida SB 482, California AB 2992/AB 930, NY synthetic-performer 6/9/2026, EU AI Act Article 50 (8/2/2026 consumer-facing AI interaction disclosure) — flag any rule that the audit cannot verify from inputs.

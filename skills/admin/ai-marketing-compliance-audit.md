...
2. **Map each L1–L4 element to its jurisdictional disclosure obligation.** Use a rules matrix keyed on (a) jurisdiction, (b) asset channel (MLS / brokerage site / Zillow / Realtor.com / IG / FB / email / AI chatbot / agent voicemail / open-house sign), (c) AI level. Typical obligations to check, at minimum:
   ...
   - **State AI / image-disclosure statutes** — California AB 723 (effective 1/1/2026): digitally altered marketing images require a clear disclosure AND a link / URL / QR code to the unaltered original; misdemeanor exposure for non-compliance. **Colorado Automated Decision-Making Technology Act (SB 26-189, signed May 14, 2026, effective January 1, 2027):** Colorado repealed-and-replaced the original AI Act (SB 24-205, which would have taken effect June 30, 2026) with a lighter-touch framework that (a) keeps real estate / housing inside the "consequential decision" scope but (b) eliminates the risk-management-program and impact-assessment duties that defined the prior law and (c) reframes the agent / brokerage obligation around three core consumer-facing duties for deployers of a "covered ADMT" — a system that processes personal data and *materially influences* a consequential decision in housing, employment, lending, insurance, healthcare, education, or essential government services. The three SB 26-189 deployer duties are: **(1) pre-use notice** to the consumer before the covered ADMT is used in a consequential decision (must identify the deployer, the decision being made, the role of the ADMT, and a plain-English summary of how the system contributes); **(2) post-adverse-outcome notice** within 30 days when the covered ADMT materially influences an adverse decision (e.g., a denial, downgrade, or unfavorable price); **(3) consumer-rights** — access and correction of personal data used by the system, and the right to request meaningful human review where commercially reasonable. **Scope guidance for residential real estate practitioners:** AI-drafted marketing copy by itself does not generally qualify as a "covered ADMT" because it does not materially influence a consequential decision about a specific consumer. The risk surface is concentrated in (i) AI lead-scoring or buyer-readiness systems that determine which Colorado consumers are contacted or prioritized, (ii) AI-driven pricing or CMA-generated price recommendations surfaced to a consumer as the price, (iii) AI tenant-screening or rental-application scoring, (iv) AI mortgage / financing pre-qualification surfaces, (v) any agentic-escrow or transaction-management AI that makes go / no-go calls on closing tasks affecting a specific Colorado consumer. **Audit implication:** for assets that fall outside the covered-ADMT definition, the SB 26-189 obligations do not bite — but a brokerage that deploys a covered ADMT in any Colorado-facing workflow must build the pre-use notice + adverse-outcome notice + human-review pathway by January 1, 2027. **What changed since v2.0:** the v2.0 of this skill cited the old SB 24-205 risk-management-policy + NIST AI RMF + ISO/IEC 42001 + impact-assessment regime with a June 30, 2026 deadline; that regime has been **repealed**. Agents reading the v2.0 audit must be told the deadline moved and the obligation structure simplified; flag this loudly in any audit produced in the June–December 2026 window. Other states have analogous statutes in varying stages — Texas RAIGA, Florida SB 482, California AB 2992/AB 930, NY synthetic-performer 6/9/2026, EU AI Act Article 50 (8/2/2026 consumer-facing AI interaction disclosure) — flag any rule that the audit cannot verify from inputs.
...
- **Colorado SB 26-189 transition rule (June 2026 → January 1, 2027):** in any audit produced in this window, if any asset will publish to a Colorado audience or the deploying agent / brokerage operates a covered ADMT in Colorado, surface a banner-level advisory that (a) the SB 24-205 June 30, 2026 deadline **no longer applies** — the replacement framework SB 26-189 governs and is effective January 1, 2027; (b) any AI risk-management-policy / NIST-AI-RMF / impact-assessment program built in anticipation of the SB 24-205 regime is **no longer a regulatory floor** in Colorado, though it remains best practice and may be required by individual brokerage policy; (c) the obligation footprint shifts to the three SB 26-189 deployer duties (pre-use notice, post-adverse-outcome notice, consumer-rights pathway) and bites only for systems that qualify as "covered ADMT." Recommend broker / counsel review before retiring any existing SB 24-205-grade program — the prudent path is to keep the program in place as best practice and layer SB 26-189-specific notices on top.
